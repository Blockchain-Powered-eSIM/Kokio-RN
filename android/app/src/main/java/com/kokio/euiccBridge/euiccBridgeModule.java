...
public class euiccBridgeModule extends ReactContextBaseJavaModule {

    private final static String TAG = euiccBridgeModule.class.getCanonicalName();
    ...
    euiccBridgeModule(ReactApplicationContext reactContext) {
        super(reactContext);
